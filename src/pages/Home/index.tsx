			...
			<EllipseBg showSun moveSunUp="unset" moveSunDown="109px" showMint moveMintUp="0px">
				<Spacing margin="auto" paddingSm="20px" padding="60px">
					...
					<Text fontWeight={500} textAlign="center">
						Deftity combines three different platforms in one same ecosystem: a metaverse game, market data aggregator
						with index fund, and private access launchpad focusing on niche markets
					</Text>
					...
					<Spacing fullWidth marginTop="50px">
						<Flex flexDirectionSm="column">
							...
							<a href="https://docsend.com/view/pkxf3t4dy9bjyjt6" target="_blank" rel="noreferrer"><RegularButton
								stretch>Whitepaper</RegularButton></a>
						</Flex>
						...
						<Spacing fullWidth marginTop="20px">
							<Flex flexDirectionSm="column">
								<Spacing marginRight="40px" marginRightSm="0px" marginBottomSm="20px">
									<Flex>
										<a
											href="https://docsend.com/view/ydgq769zq6ejjnbf"
											target="_blank"
											rel="noreferrer"><OutlinedButton>One Pager</OutlinedButton></a>
									</Flex>
								</Spacing>
								<a href="https://docsend.com/view/vex4z4hgqzsftzvi" target="_blank" rel="noreferrer"><OutlinedButton>Pitch
								                                                                                                     Deck</OutlinedButton></a>
							</Flex>
						</Spacing>
					</Spacing>
				</Spacing>
			...
			>
				<FeaturesGrid>
					<div>
						...
						<Text fontWeight={500}>
							Deftify's Private Access Pad (PAP) is for African founders and developers who have the next big blockchain
							idea
							but do not know how to start. PAP is designed perfectly to help match ideas with teams, fund and
							accelerate
...
<<<<<<< HEAD
				<Flex itemsFlex={0.6} itemsFlexMd={0.9}>
					<Text mt="16px" textAlign="center">
						...
						launchpad, and advanced data aggregation tools with tradable index funds are all part of the same
